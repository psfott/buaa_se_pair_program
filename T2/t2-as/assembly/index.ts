...
export function mancalaResult(flag: i32, seq: i32[], size: i32): i32 {
    ...
    return flag == 1 ? 20000 + countMap.get(6) : 20000 + countMap.get(13);
}
...
export function over(flag: i32,countMap: Map<i32,i32>): i32 {
    ...
    if (flag == 1) {
        return 15000 + sum1 - sum2;
    }
    return 15000 + sum2 - sum1;
}
